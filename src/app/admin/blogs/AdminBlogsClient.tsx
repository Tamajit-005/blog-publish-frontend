  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto">
        ...
        {blogs.length === 0 ? (
          <p className="text-gray-400">No pending blogs.</p>
        ) : (
          <div className="space-y-6">
            {blogs.map((blog) => (
              <div
                key={blog._id}
                onClick={() => router.push(`/admin/blogs/${blog._id}`)} // ✅ Make entire card clickable
                className="bg-gray-900 border border-gray-800 rounded-lg overflow-hidden hover:border-teal-500 transition-all cursor-pointer"
              >
